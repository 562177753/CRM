      ...
      //  console.log(data);
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            row = '<tr>' +
                ...
                '</td>' +
                ' <td style="background: #FFFFFF">' +
                ' <input type="text" readonly="readonly" data-key="level_id" value="' + level_id + '" style="border-style:none;outline:none;text-align: center; background: #FFFFFF;"/>' +
                ' </td>' +
                '<td>' +
                '<input type="number" min="0" data-key="yueliushui" value="' + yueliushui + '" style="text-align: center;border:none; background: #FFFFFF;" />' +
                ' </td>' +
                ' <td>' +
                ' <input type="number" min="0" data-key="ritonghua" value="' + ritonghua + '" style="text-align: center;border:none; background: #FFFFFF;"/>' +
                ' </td>' +
                ' <td>' +
                ' <input type="number" min="0" data-key="zhouhuifangbi" value="' + zhouhuifangbi + '" style="text-align: center;border:none; background: #FFFFFF;"/>' +
                ' </td>' +
                ' <td>' +
                ' <input type="number" min="0" data-key="kuaqihuifangbi" value="' + kuaqihuifangbi + '" style="text-align: center;border-style:none; background: #FFFFFF;"/>' +
                ' </td>' +
                '</tr>';
            table.append(row);
        }
