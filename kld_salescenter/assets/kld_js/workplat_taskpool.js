...
$(document).ready(function () {
    ...
    // 批量领取
    $('#batch_get_btn').on('click', function () {
        onTriggerEventHandler('#batch_get_btn');
    });
    // 全选
    $('#row_all_chk').on('change', function () {
        onTriggerEventHandler('#row_all_chk')
    });
    // 当点击 上一页、下一页  输入值
    ...
    service.get_campus_big_id_pool(params)
        .then(function (data) {
